 ...
 * @subpackage multisite_general_functions/public
 */
 ...
 */
class multisite_general_functions_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/multisite-general-functions-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/multisite-general-functions-public.js', array( 'jquery' ), $this->version, false );
